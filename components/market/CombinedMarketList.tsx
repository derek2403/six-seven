    ...
    return (
        <div className="flex flex-col gap-3 w-full max-w-full">
            {COMBINED_MARKETS.map((market, idx) => (
                <div key={market.id} className="flex items-center gap-3 w-full">
                    {/* Avatar */}
                    ...
                    <div className="flex items-center justify-between w-full min-w-0 overflow-hidden">
                        ...
                        {idx === 0 && (
                            <div className="flex items-center gap-1.5 ml-4 flex-shrink-0">
                                <Button variant="ghost" className="h-9 w-9 p-0 text-gray-400 hover:text-black hover:bg-transparent">
