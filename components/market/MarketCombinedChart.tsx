...
const OutcomeSlider = ({ selectedMarkets, currentValues, markets, marketSelections, onMarketSelectionsChange }: {
...
const WorldTable = ({ marketSelections }: { marketSelections?: Record<string, MarketSelection> }) => {
    const worlds = [
