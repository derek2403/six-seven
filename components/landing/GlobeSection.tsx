...
import { AnimatedListDemo, Item } from "../AnimatedListDemo";
...
const GlobeSection = () => {
    ...
    return (
        <section className="min-h-[170vh] w-full flex items-start justify-center pt-20 pb-96 bg-white relative overflow-visible">
