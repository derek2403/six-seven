...
const CRYPTO_MARKETS: CombinedMarketItem[] = [
    { id: "m1", title: "Bitcoin > $100k by Jan 31?", avatar: "https://cryptologos.cc/logos/bitcoin-btc-logo.png", targetPrice: 100000 },
    { id: "m2", title: "Ethereum > $4k by Jan 31?", avatar: "https://cryptologos.cc/logos/ethereum-eth-logo.png", targetPrice: 4000 },
    { id: "m3", title: "Sui > $5 by Jan 31?", avatar: "https://cryptologos.cc/logos/sui-sui-logo.png", targetPrice: 5 },
];

const CRYPTO_LEGEND: LegendItem[] = [
    { label: "Bitcoin > $100k by Jan 31?", value: "65%", color: "#60a5fa" },
    { label: "Ethereum > $4k by Jan 31?", value: "42%", color: "#2563eb" },
    { label: "Sui > $5 by Jan 31?", value: "88%", color: "#facc15" },
];
